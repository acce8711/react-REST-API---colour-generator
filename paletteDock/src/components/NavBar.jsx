                ...
                <li className="nav-item">
                    <button onClick={() => props.changeNavItem(0)}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.25 8.75H17.5V11.25H11.25V17.5H8.75V11.25H2.5V8.75H8.75V2.5H11.25V8.75Z" fill="black"/>
                        </svg>
                    </button>
                </li>
                ...
                <li className="nav-item">
                    <button onClick={() => props.changeNavItem(2)}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.91943 15H9.00006V22.8508L20.0807 9.00001H15.0001V1.14923L3.91943 15ZM11.0001 13H8.08068L13.0001 6.85079V11H15.9194L11.0001 17.1492V13Z" fill="black"/>
                        </svg>
                    </button>
                </li>
            </ul>
